class Agreement < ActiveRecord::Base
  ...
  def format_pdf(entity)
      ...
      pdf.move_down 10
      pdf.text "You grant to Us a perpetual, worldwide, non-exclusive, transferable, royalty-free, irrevocable patent license, with the right to sublicense these rights to multiple tiers of sublicensees, to make, have made, use, sell, offer for sale, import and otherwise transfer the Contribution and the Contribution in combination with the Material (and portions of such combination); provided that this license is conditioned upon compliance with Section 2.3. This patent license includes, without limitation, method, process, and apparatus claims which You" + affiliates + " own, control or have the right to grant, now or in the future, but only to the extent to which making, having made, using, selling, offering for sale, importing or otherwise transferring the Contribution, or the Contribution in combination with the Material as it exists on the Submission Date, infringes such patent claims."
      ...
      pdf.text "As a condition on the grant of rights in Sections 2.1 and 2.2, We agree to license the Contribution only under the terms of the license or licenses which We are using on the Submission Date for the Material or any licenses which are recommended by the Free Software Foundation for use in GNU projects on or after the Effective Date, whether or not such licenses are subsequently disapproved (including any right to adopt any future version of a license if permitted)."
